...
file_path = 'benchmark/RAG_exp/nq-open-10_0.jsonl'
...
if max_samples is not None:
    total_num = min(total_num, max(1, int(max_samples)))
correct_num = 0
res_list = []
...
file_name = f"result/nolink_select_{args.name}_NQ_at{pos}_{accuracy}.jsonl"
