...
data = []
data.extend(load_jsonline(fp=f"{data_dir}/rag/2wiki_eval/dataset"))
...
for i in tqdm(range(total_num)):
    ...
    with torch.no_grad():
        ...
        print("Wiki_nolink", correct_num / (i+1))
    

accuracy = correct_num / total_num

file_name = f"result/wiki_nolink-select_{args.name}_{accuracy}.jsonl"
